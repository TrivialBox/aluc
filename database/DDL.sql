...
BEGIN
    ...
    if (valor > 0 and Sn_usuarios <= valor ) then
        ...
        INSERT INTO ALUC.reservacion 
			values(NULL, Sid_laboratorio,Sid_usuario, Sestado, Sfecha, Shora_inicio, Shora_fin,NULL);
		COMMIT;
	else
