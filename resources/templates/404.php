    ...
    <div class="container-fluid">
        <div class="row-fluid"><br>
            <div class="col-lg-12"><br>
                <div class="centering text-center"><brre    sssss>
                    <div class="text-center">
                        <div class="panel panel-danger ">
                            <div class="panel-heading jumbotron">
                                <h1 class="without-margin panel-title">No te preocupes.<br> Solo es error <span class="text-success"><big>404</big></span></h1>
                            </div>
